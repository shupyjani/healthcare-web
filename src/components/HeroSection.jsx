...
function HeroSection() {
    ...
    return (
        <div className='hero-container'>
            ...
            <h1 data-aos="fade-right" data-aos-duration="2000"><span className='heading-span1'>AJANI</span> <span className='heading-span2'>HEALTH</span> <span className='heading-span3'>CARE</span>  - Quality Care You Can Trust</h1>
